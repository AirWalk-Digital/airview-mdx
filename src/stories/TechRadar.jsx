...
const TechRadar = ({ title = 'blank', quadrants, rings, entries, width = '1450', height = '1000', print_layout = true, links_in_new_tabs = true, sx = {}, ...props }) => {
  ...
  links_in_new_tabs: links_in_new_tabs,
  // zoomed_quadrant: 0,
  //ENTRIES
  entries: entries
  //ENTRIES
  ...
  console.log('TechRadar:radarData: ', radarData)
  console.log('TechRadar:quadrants: ', quadrants)
  ...
  const data = [
    { name: "React", ring: "adopt", quadrant: "frameworks", moved: 0 },
    { name: "TypeScript", ring: "adopt", quadrant: "languages", moved: 1 },
    { name: "GraphQL", ring: "trial", quadrant: "techniques", moved: -1 },
    { name: "Kubernetes", ring: "adopt", quadrant: "platforms", moved: 0 },
  ];
